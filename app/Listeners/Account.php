...
use App\Services\Logic\Account\RegisterReferer as RegisterRefererService;
...
class Account extends Listener
{
    ...
    {
        $this->handleRegisterReferer($user);
    ...
    protected function handleRegisterReferer(UserModel $user)
    {
        $referer = new RegisterRefererService();
