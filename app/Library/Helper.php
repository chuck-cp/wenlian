 ...
 * @return array
 */
function kg_array_unique_multi($array, $key)
{
    $uniqueArray = [];
    $encounteredKeys = [];
 ...
 * @return string
 */
function kg_default_paper_cover_path()
{
    return '/img/default/paper_cover.png';
}
 ...
 * @return string
 */
function kg_cos_paper_cover_url($path, $style = null)
{
    $path = $path ?: kg_default_paper_cover_path();
