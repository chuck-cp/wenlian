...
class Upload extends Model
{
    ...
    const TYPE_DOC_FILE = 5; // 文档文件
    const TYPE_IM_FILE = 6; // IM文件（已弃用）
    const TYPE_ICON_IMG = 7; // 图标
    const TYPE_INVOICE_FILE = 8; // 发票
    const TYPE_EXAM_QUESTION_IMG = 9; // 试题图片
    const TYPE_EXAM_ANSWER_FILE = 10; // 答案文件
