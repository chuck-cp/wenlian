...
class ReportController extends Controller
{
    ...
    /**
     * @Get("/exam/questions", name="admin.report.exam_questions")
     */
    public function examQuestionsAction()
    {
        $reportService = new ReportService();

        $pager = $reportService->getExamQuestions();

        $this->view->pick('report/exam_questions');
        $this->view->setVar('pager', $pager);
    }
