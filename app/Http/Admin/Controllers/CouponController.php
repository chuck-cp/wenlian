...
class CouponController extends Controller
{
    ...
    public function editAction($id)
    {
        ...
        $xmExamPapers = $service->getXmExamPapers($coupon);
        $xmArticles = $service->getXmArticles($coupon);
    ...
    /**
     * @Get("/{id:[0-9]+}/orders", name="admin.coupon.orders")
     */
    public function ordersAction($id)
    {
        ...
        $coupon = $service->getCoupon($id);
        $pager = $service->getCouponOrders($id);
