...
class User extends Service
{
    ...
    public function getUserBalance($id)
    {
        ...
        return $userRepo->findUserBalance($id);
    }
    ...
    public function updateUser($id)
    {
        ...
        $post = $this->request->getPost();
        $post['vip_expiry_time'] = '2099-01-01 00:00:00';
        $post['vip'] = 1;
    ...
    public function updateProfile($id)
    {
        ...
        $user->profile = $validator->checkProfile($post['profile']);
    ...
    protected function destroyUserLogin(UserModel $user)
    {
        ...
        $homeAuth->logoutAllClients($user->id);

        $apiAuth = new ApiAuth();

        $apiAuth->logoutAllClients($user->id);
    }
