...
class Slide extends Service
{
    ...
    public function createSlide()
    {
        ...
        } elseif ($post['target'] == SlideModel::TARGET_EXAM_PAPER) {
            $slide = $this->createExamPaperSlide($post);
        } elseif ($post['target'] == SlideModel::TARGET_ARTICLE) {
            $slide = $this->createArticleSlide($post);
        }
    ...
    protected function createExamPaperSlide($post)
    {
        $validator = new SlideValidator();
        ...
        $slide->cover = $paper->cover;
        $slide->content = $paper->id;
        $slide->target_attrs = [
            'exam_paper' => [
                'id' => $paper->id,
                'title' => $paper->title,
    ...
    protected function createArticleSlide($post)
    {
        $validator = new SlideValidator();
