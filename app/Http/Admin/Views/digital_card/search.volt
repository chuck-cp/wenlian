...
{% block content %}
    ...
    {% if target == 'search' %}
        {% set action_url = url({'for':'admin.digital_card.list'}) %}
        {% set title = '搜索兑换码' %}
    {% else %}
        {% set action_url = url({'for':'admin.digital_card.export'}) %}
        {% set title = '导出兑换码' %}
    {% endif %}
    ...
    <form class="layui-form kg-form" method="GET" action="{{ action_url }}">
        ...
        <div id="block-4" class="block" style="display:none;">
            <div class="layui-form-item">
        ...
        <div id="block-5" class="block" style="display:none;">
            <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="usable" value="0" title="是">
                <input type="radio" name="usable" value="1" title="否">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">已作废</label>
            <div class="layui-input-block">
