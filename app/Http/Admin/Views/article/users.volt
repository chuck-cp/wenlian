...
{% block content %}
    ...
    {% set add_url = url({'for':'admin.article.add_user','id':article.id}) %}
    {% set search_url = url({'for':'admin.article.search_user','id':article.id}) %}
    ...
    <table class="layui-table kg-table">
        ...
        {% for item in pager.items %}
            ...
            {% set edit_url = url({'for':'admin.article.edit_user','id':item.id}) %}
            {% set delete_url = url({'for':'admin.article.delete_user','id':item.id}) %}
