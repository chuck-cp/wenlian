...
{% block content %}
    ...
    {% set create_url = url({'for':'admin.article.create_user','id':article.id}) %}
    {% set import_url = url({'for':'admin.article.import_user','id':article.id}) %}
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-form-mid layui-word-aux">
                                通过模板批量导入专栏学员，减少繁琐的添加操作。<a href="/static/admin/tpl/专栏学员批量导入模板.xlsx" target="_blank">（下载专栏学员批量导入模板）</a>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
