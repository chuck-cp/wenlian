                ...
                <td class="center">
                    <div class="kg-dropdown">
                        ...
                        <ul>
                            ...
                            {% if item.deleted == 0 %}
                                <li><a href="javascript:" class="kg-delete" data-url="{{ delete_url }}">删除回答</a></li>
                            {% else %}
                                <li><a href="javascript:" class="kg-restore" data-url="{{ restore_url }}">还原回答</a></li>
                            {% endif %}
                            <hr>
