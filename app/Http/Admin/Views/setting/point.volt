    ...
    <form class="layui-form kg-form" method="POST" action="{{ url({'for':'admin.setting.point'}) }}">
        ...
        <table class="layui-table layui-form kg-table" style="width:80%;">
            ...
            <tr>
                <td>挑错被采纳</td>
                <td>
                    <input type="radio" name="event_rule[criticize_accepted][enabled]" value="1" title="是" {% if event_rule.criticize_accepted.enabled == "1" %}checked="checked"{% endif %}>
                    <input type="radio" name="event_rule[criticize_accepted][enabled]" value="0" title="否" {% if event_rule.criticize_accepted.enabled == "0" %}checked="checked"{% endif %}>
                </td>
                <td><input class="layui-input" type="text" name="event_rule[criticize_accepted][point]" value="{{ event_rule.criticize_accepted.point }}" lay-verify="required"></td>
                <td><input class="layui-input" type="text" name="event_rule[criticize_accepted][limit]" value="{{ event_rule.criticize_accepted.limit }}" lay-verify="required"></td>
            </tr>
            </tbody>
        </table>
        <br>
