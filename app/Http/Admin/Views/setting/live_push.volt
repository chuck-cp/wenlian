...
{% set push_record_display = push.record_enabled == 1 ? 'display:block' : 'display:none' %}
...
<form class="layui-form kg-form" method="POST" action="{{ url({'for':'admin.setting.live'}) }}">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">开启录制</label>
        <div class="layui-input-block">
            <input type="radio" name="record_enabled" value="1" title="是" lay-filter="push_record_enabled" {% if push.record_enabled == 1 %}checked="checked"{% endif %}>
            <input type="radio" name="record_enabled" value="0" title="否" lay-filter="push_record_enabled" {% if push.record_enabled == 0 %}checked="checked"{% endif %}>
        </div>
    </div>
    <div id="push-record-block" style="{{ push_record_display }}">
        <div class="layui-form-item">
            <label class="layui-form-label">录制模板ID</label>
            <div class="layui-input-block">
                <input class="layui-input" type="text" name="record_tpl_id" value="{{ push.record_tpl_id }}">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
