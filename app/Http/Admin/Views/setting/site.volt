...
{% block content %}
    ...
    <form class="layui-form kg-form" method="POST" action="{{ url({'for':'admin.setting.site'}) }}">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="private" value="0" title="开启" {% if site.private == 0 %}checked="checked"{% endif %}>
                <input type="radio" name="private" value="1" title="关闭" {% if site.private == 1 %}checked="checked"{% endif %}>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">屏蔽右键</label>
            <div class="layui-input-block">
                <input type="radio" name="copy_enabled" value="0" title="开启" {% if site.copy_enabled == 0 %}checked="checked"{% endif %}>
                <input type="radio" name="copy_enabled" value="1" title="关闭" {% if site.copy_enabled == 1 %}checked="checked"{% endif %}>
            </div>
        </div>
        <div class="layui-form-item">
