...
{% block content %}
    ...
    <form class="layui-form kg-form" method="GET" action="{{ url({'for':'admin.cert.list'}) }}">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input class="layui-input" type="text" name="name" placeholder="证书名称模糊匹配">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                {% for value,title in grant_types %}
                    <input type="checkbox" name="grant_type" value="{{ value }}" title="{{ title }}">
                {% endfor %}
            </div>
        </div>
        <div class="layui-form-item">
