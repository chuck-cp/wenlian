...
{% block content %}
    ...
    {% set sale.item_info = objectify(sale.item_info) %}
    ...
    <form class="layui-form kg-form" method="POST" action="{{ url({'for':'admin.flash_sale.update','id':sale.id}) }}">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-mid gray">个</div>
        </div>
        <div class="layui-form-item" id="time-range">
            <label class="layui-form-label">活动时间</label>
            <div class="layui-input-inline">
                <input class="layui-input" id="start-time" type="text" name="start_time" autocomplete="off" value="{{ sale.start_time }}" lay-verify="required">
            </div>
            <div class="layui-form-mid gray">至</div>
            <div class="layui-input-inline">
                <input class="layui-input" id="end-time" type="text" name="end_time" autocomplete="off" value="{{ sale.end_time }}" lay-verify="required">
            </div>
        </div>
        <div class="layui-form-item">
