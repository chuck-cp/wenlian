...
{%- macro single_choice(question, sn) %}
    <div class="exam-question wrap" id="question-{{ question.id }}" data-pid="{{ question.parent_id }}">
...
{%- macro multiple_choice(question, sn) %}
    <div class="exam-question wrap" id="question-{{ question.id }}" data-pid="{{ question.parent_id }}">
        ...
        <div class="compare-box">
            <button class="layui-btn layui-btn-danger check-answer" data-sn="{{ sn }}" data-id="{{ question.id }}" data-pid="{{ question.parent_id }}" data-model="{{ question.model }}">比对答案
            </button>
