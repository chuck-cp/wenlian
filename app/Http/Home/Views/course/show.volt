...
{% block content %}
    ...
    <div class="layout-main">
        ...
        {% set show_tab_papers = course.paper_count > 0 %}
            ...
            <div class="course-tab-wrap wrap">
                <div class="layui-tabs course-tab">
                    <ul class="layui-tabs-header">
                        ...
                        {% endif %}
                        {% if show_tab_papers %}
                            <li>练习<span class="tab-count">{{ course.paper_count }}</span></li>
                        {% endif %}
                    </ul>
                    <div class="layui-tabs-body">
                        ...
                        {% if show_tab_consults %}
                            ...
                            <div class="layui-tabs-item" id="tab-consults" data-url="{{ consults_url }}"></div>
                        {% endif %}
                        {% if show_tab_reviews %}
                        ...
                        {% endif %}
                        {% if show_tab_papers %}
                            {% set papers_url = url({'for':'home.course.exam_papers','id':course.id}) %}
                            <div class="layui-tabs-item" id="tab-papers" data-url="{{ papers_url }}"></div>
                        {% endif %}
                    </div>
                </div>
            </div>
