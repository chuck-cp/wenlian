{% set manage_url = url({'for':'home.live.manage','id':chapter.id}) %}
...
<div class="toolbar-sticky">
    ...
    {% if chapter.me.manager == 1 %}
        <div class="item live-set">
            <div class="icon icon-set" title="直播管理" data-url="{{ manage_url }}">
