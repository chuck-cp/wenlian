...
{% block link_css %}
    ...
    {{ css_link('home/css/chapter.player.css') }}
        ...
        <div class="layout-sidebar">
            <div class="layui-card chat-wrap">
                ...
                <div class="layui-card-body">
                    ...
                    {% if chapter.settings.chat_enabled == 1 %}
                        <form class="layui-form chat-msg-form" method="post" action="{{ send_msg_url }}">
                            <input class="layui-input" type="text" name="content" maxlength="50" placeholder="请输入内容" lay-vertype="tips" lay-verify="required">
                            <button class="layui-hide" type="submit" lay-submit="true" lay-filter="chat">发送</button>
                        </form>
                    {% else %}
                        <div class="chat-closed-tips">
