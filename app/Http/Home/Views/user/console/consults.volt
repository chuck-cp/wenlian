                    ...
                    <table class="layui-table consult-table" lay-skin="line">
                        ...
                        {% for item in pager.items %}
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="layui-btn layui-btn-xs btn-show-consult" data-url="{{ show_url }}">详情</button>
                                    <button class="layui-btn layui-btn-xs layui-btn-normal btn-edit-consult" data-url="{{ edit_url }}">修改</button>
                                    <button class="layui-btn layui-btn-xs layui-btn-danger kg-delete" data-url="{{ delete_url }}">删除</button>
                                </td>
                            </tr>
                        {% endfor %}
                        </tbody>
