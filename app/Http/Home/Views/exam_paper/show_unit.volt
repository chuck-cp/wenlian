...
{% block content %}
    ...
    {% set latest_users_url = url({'for':'home.exam_paper.latest_unit_users','id':paper.id}) %}
    ...
    <div class="layout-main">
        <div class="layout-content">
            <div class="layui-card">
                <div class="layui-card-header">最新学员</div>
                <div class="layui-card-body">
                    <div id="latest-unit-users" data-url="{{ latest_users_url }}"></div>
                </div>
            </div>
        </div>
        <div class="layout-sidebar">
            ...
            {% elseif paper.me.owned == 1 %}
                ...
                <div class="sidebar wrap">
                    <button class="layui-btn layui-btn-normal layui-btn-fluid btn-join" data-url="{{ join_url }}">开始练习</button>
                </div>
