...
use App\Services\Logic\Search\ExamPaper as ExamPaperSearchService;
...
class SearchController extends Controller
{
    ...
    /**
     * @param string $type
     * @return ExamPaperSearchService|ArticleSearchService|QuestionSearchService|CourseSearchService
     */
    protected function getSearchService($type)
    {
        switch ($type) {
            case 'exam_paper':
                $service = new ExamPaperSearchService();
                break;
            case 'article':
