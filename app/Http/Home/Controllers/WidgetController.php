...
use App\Caches\FeaturedExamPaperList as FeaturedExamPaperListCache;
...
class WidgetController extends Controller
{
    ...
    /**
     * @Get("/featured/exam/papers", name="home.widget.featured_exam_papers")
     */
    public function featuredExamPaperAction()
    {
        $cache = new FeaturedExamPaperListCache();

        $examPapers = $cache->get();

        $this->view->setRenderLevel(View::LEVEL_ACTION_VIEW);
        $this->view->pick('widget/featured_exam_papers');
        $this->view->setVar('exam_papers', $examPapers);
    }
