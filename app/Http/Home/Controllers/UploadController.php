...
class UploadController extends Controller
{
    ...
    /**
     * @Post("/exam/answer/file", name="home.upload.exam_answer_file")
     */
    public function uploadExamAnswerFileAction()
    {
        $service = new StorageService();

        $file = $service->uploadExamAnswerFile();
        ...
        $data = [
            'id' => $file->id,
            'name' => $file->name,
            'url' => $service->getFileUrl($file->path),
        ];
