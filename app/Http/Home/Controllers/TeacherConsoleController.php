...
use App\Services\Logic\Teacher\Console\GradeExamList as GradeExamListService;
...
class TeacherConsoleController extends Controller
{
    ...
    /**
     * @Get("/grade/exams", name="home.tc.grade_exams")
     */
    public function gradeExamsAction()
    {
        $service = new GradeExamListService();

        $pager = $service->handle();

        $this->view->pick('teacher/console/grade_exams');
        $this->view->setVar('pager', $pager);
    }
