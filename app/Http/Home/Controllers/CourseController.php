...
use App\Services\Logic\Course\ExamPaperList as CourseExamPaperListService;
...
class CourseController extends Controller
{
    ...
    /**
     * @Get("/{id:[0-9]+}/exam/papers", name="home.course.exam_papers")
     */
    public function examPapersAction($id)
    {
        $service = new CourseExamPaperListService();

        $examPapers = $service->handle($id);

        $this->view->setRenderLevel(View::LEVEL_ACTION_VIEW);
        $this->view->pick('course/exam_papers');
