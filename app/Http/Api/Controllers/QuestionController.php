...
use App\Services\Logic\Question\TagList as TagListService;
...
class QuestionController extends Controller
{
    ...
    /**
     * @Get("/tags", name="api.question.tags")
     */
    ...
    /**
     * @Post("/create", name="api.question.create")
     */
    public function createAction()
    {
        ...
        $question = $service->handle($question->id);
