...
use App\Services\Logic\Chapter\DanmuList as DanmuListService;
...
class ChapterController extends Controller
{
    ...
    /**
     * @Get("/{id:[0-9]+}/danmus", name="api.chapter.danmus")
     */
    public function danmusAction($id)
    {
        $service = new DanmuListService();

        $danmus = $service->handle($id);

        return $this->jsonSuccess(['danmus' => $danmus]);
    }
