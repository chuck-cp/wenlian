...
class CleanLogTask extends Task
{
    ...
    public function mainAction()
    {
        ...
        $this->cleanTradeLog();
        $this->cleanRefundLog();
        $this->cleanInvoiceLog();
        $this->cleanWithdrawLog();
        $this->cleanAffiliateLog();
        $this->cleanPointLog();
     ...
     * 清理开票日志
     */
    protected function cleanInvoiceLog()
    {
        $type = 'invoice';
     ...
     * 清理提现日志
     */
    protected function cleanWithdrawLog()
    {
        $type = 'withdraw';
     ...
     * 清理分销日志
     */
    protected function cleanAffiliateLog()
    {
        $type = 'affiliate';
     ...
     * 清理发货日志
     */
    protected function cleanDeliverLog()
    {
        $type = 'deliver';
     ...
     * 清理企业微信日志
     */
    protected function cleanWeWorkLog()
    {
        $type = 'wework';
     ...
     * 清理队列日志
     */
    protected function cleanQueueLog()
    {
        $type = 'queue';
