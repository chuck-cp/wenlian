...
trait CountTrait
{
    ...
    protected function handleItemReportCount($item)
    {
        ...
        } elseif ($item instanceof ExamQuestionModel) {
            $this->incrExamQuestionReportCount($item);
        }
    }
    ...
    protected function incrExamQuestionReportCount(ExamQuestionModel $question)
    {
        $question->report_count += 1;
