...
class FullWebUrl extends Service
{
    ...
    public function getGrouponShowUrl($id)
    {
        $route = $this->url->get(['for' => 'home.groupon.show', 'id' => $id]);
    ...
    public function getExamPaperShowUrl($id)
    {
        $route = $this->url->get(['for' => 'home.exam_paper.show', 'id' => $id]);
