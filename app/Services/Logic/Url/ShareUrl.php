...
class ShareUrl extends AppService
{
    ...
    public function getGrouponUrl($id)
    {
        $webUrl = $this->fullWebUrl->getGrouponShowUrl($id);

        $h5Url = $this->fullH5Url->getGrouponInfoUrl($id);
    ...
    public function getExamPaperUrl($id)
    {
        $webUrl = $this->fullWebUrl->getExamPaperShowUrl($id);

        $h5Url = $this->fullH5Url->getExamPaperInfoUrl($id);
