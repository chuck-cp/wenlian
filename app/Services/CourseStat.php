...
class CourseStat extends Service
{
    ...
    public function updateAttrs($courseId)
    {
        ...
        } elseif ($course->model == CourseModel::MODEL_DOC) {
            $this->updateDocAttrs($course->id);
        }
    }

    protected function updateReadAttrs($courseId)
    {
        $courseRepo = new CourseRepo();
    ...
    protected function updateLiveAttrs($courseId)
    {
        $courseRepo = new CourseRepo();
    ...
    protected function updateOfflineAttrs($courseId)
    {

    }

    protected function updateDocAttrs($courseId)
    {
        $courseRepo = new CourseRepo();
        ...
        foreach ($lessons as $lesson) {
            ...
            if ($lesson->model != CourseModel::MODEL_DOC) continue;
